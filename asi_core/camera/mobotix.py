...
def read_timestamp_from_header(header):
    ...
    timezone_pattern = r"TZN=(GMT[+-]\d+|UTC|CET|CEST|AWST)"
    ...
    if timezone_str == 'UTC':
        ...
        timezone_str = 'GMT+2'
    elif timezone_str == 'AWST':
        timezone_str = 'GMT+8'

    datetime_str = f"{date_match.group(1)}T{time_match.group(1)}{timezone_str.replace('GMT', '')}:00"
